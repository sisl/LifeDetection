...
push!(
	...
	DiscreteCPD(:o7, [:o2], [2], [
		...
		DiscreteBeta(2, 1, bins=5),    # cell membrane
	]),
)
...
# P(o8 | o5 = 0 to 22)
o5_cpds = [DiscreteBeta(1 + i/176, 1, bins=5) for i ∈ 0:22]
...
# pH: 15 bins
o1_cpds = [
	DiscreteGaussian(9.0, 5.0, lo=0.0, hi=14.0, bins=14),
	DiscreteGaussian(10.0, 7.0, lo=0.0, hi=14.0, bins=14),
]
o5_cpds = [
